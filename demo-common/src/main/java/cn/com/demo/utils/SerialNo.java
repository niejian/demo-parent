...
public class SerialNo {
    ...
    public static synchronized String getUNID() {
        ...
        String currentTime = CustDateUtils.getFormat("yyMMddHHmmssSSS", new Date());
    ...
    public static String getSerialforDB() {
        return CustDateUtils.getFormat("yyMMddHHmmssSSS", new Date());
    }
    ...
    public static String getTimeMillisSequence() {
        ...
        int difBit = String.valueOf(Long.MAX_VALUE).length()
                - nanoTimeStr.length();
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-------------->\n\n");
        for (int i = 0; i < 10; i++) {
            IdWorker idWorker = IdWorker.getIdWorkInstance(1,2);
